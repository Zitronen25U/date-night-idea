    ...
    return (
        <CardDeck scrollable={true} style={{width: '80%', height: '30%', margin: '1% auto', padding: '5%' }}>
            ...
            <Card>
                 ...
                 <Card.Text>I am software developer based in Seattle WA. I primarily code in JavaScript and Python. That being said, 
                 I am highly interested in web development and data science. One of my great addictions is eating spicy food and drinking coffee.
                 </Card.Text>
                 </Card.Body>
            </Card>
            <Card>
                 ...
                 <Card.Text>Hi My Names Elijah. I moved to Seattle from California with my girlfriend Hannah and my two dogs Luna and Django. 
                 My Favorite things to do are eating and going on long walks with the family. Software Development is fun</Card.Text>
                 </Card.Body>
            </Card>
        </CardDeck>
    );
